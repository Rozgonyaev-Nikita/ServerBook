...
const ExchangeListSchema = new mongoose.Schema({
  //+   //ExchangeListSchema?
  idOfferList1: {
    type: mongoose.Schema.Types.ObjectId,
    ref: "OfferList",
...
export const UserExchangeList = mongoose.model(
  "UserExchangeList",
  UserExchangeListSchema
);
export const UserList = mongoose.model("UserList", UserListSchema);
export const UserValueCategory = mongoose.model(
  "UserValueCategory",
  UserValueCategorySchema
);
